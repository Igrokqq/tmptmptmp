...
function BecomeAnExpert() {
    ...
    const nextPageNumber = (pageNumber: string) => {
        ...
        if (!isNaN(numericPageNumber) && numericPageNumber >= 1 && numericPageNumber <= totalSteps) {
    ...
    const commonProps = { isExpert: true, currentPage, setCurrentPage, nextPageNumber, totalSteps };
            ...
            <ModalWrapper>
                <Modal>
                    <Routes>
                        ...
                        <Route path="/registration" element={<ExpertRegistrationPage {...commonProps} />} />
                        <Route path="/verify-email" element={<ExpertVerifyEmailPage {...commonProps} />} />
                        <Route path="/email-verification" element={<ExpertEmailVerificationPage {...commonProps} />} />
                        <Route path="/congrats" element={<CongratsPage />} />
                        <Route path="/registration-two" element={<ExpertRegistrationPageTwo {...commonProps} />} />
                        <Route path="/registration-three" element={<ExpertRegistrationPageThree {...commonProps} />} />
                        <Route path="/registration-four" element={<ExpertRegistrationPageFour {...commonProps} />} />
